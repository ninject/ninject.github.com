    ...
    $.widget("ui.tree", $.ui.mouse, {
        ...
        _createDomElements: function(tree) {
            ...
            function createNodeLi(node) {
			    if (node.href == null) 
				    ...
				    return $('<li><div><span class="title"><a class="title" href="' + node.href + '">' + node.name +'</a></span></div></li>');
            }
            ...
            function createFolderLi(node) {
                ...
                var $li = ""
			    if (node.href == null) 
				    $li = $('<li><div><a class="'+ button_classes.join(' ') +'">&raquo;</a><span class="title">'+ node.name +'</span></div></li>')
				else
				    $li = $('<li><div><a class="'+ button_classes.join(' ') +'">&raquo;</a><span class="title"><a class="title" href="' + node.href + '">' + node.name +'</a></span></div></li>');
        ...
        _click: function(e) {
           // todo: handle rightclick
            ...
            else if ($target.is('div') || $target.is('span') || $target.is('a')) {
